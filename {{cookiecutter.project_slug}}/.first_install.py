...
if os.path.isfile('./Pipfile'):
    ...
    run(['pipenv', 'install', '--python', f"{PYENV_PREFIX}/bin/python", 'ipython', 'ipykernel', 'pandas', 'matplotlib', 'notebook', '"y-py==0.5.5"', '"jupyterlab==3.6.1"', 'altair', 'jupytext', 'jupyterlab_templates', 'itables', 'ap-altair-theme'])
